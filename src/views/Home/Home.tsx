...
<img src={chef} height={150}  />
      <div style={{"background":"#4e36a7","padding":"10px","textAlign":"center","borderRadius":"5px"}}>
      <h1 style={{"color":"#fff"}}>Kai is Ready For You..!!</h1>
      <h2 style={{"color":"#fff"}}>Stake KAI-Swap LP tokens to claim your very own KAI!</h2>
      </div>
      <br />
      <Container>
        <Balances />
      ...
      <Spacer size="lg" />
      <StyledInfo>
        🏆<b>Pro Tip</b>: KAI-BNB SLP token pool yields 0.5x more token
        rewards per block.
      </StyledInfo>
      <br />
      <table>
