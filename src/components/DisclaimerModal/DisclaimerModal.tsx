    ...
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p> Kai will be the home of our new frontend, and provides
              an interface for all interactions with the KaiSwap protocol.
          </p>
          <p> Development will be on going, and kaiswap will still
              exist in the interim as we work to get Kai completely
              polished.
          </p>
        </div>
      )
